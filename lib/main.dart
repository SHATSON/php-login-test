...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<dynamic> generateEmployeeList() async {
    ...
    ///
    var url = 'http://192.168.0.12/test/get_employees_details.php';
    final _myUri = Uri.parse(url);
...
class Employee {
  ...
  Employee({required this.id, this.firstName, this.designation, this.salary});
